...
public class ExamSystemEx extends JFrame implements ActionListener
{
	JLabel l;
	...
	public ExamSystemEx(String s) 
	{
		
		super(s);
		
		l=new JLabel("MyQuestions");
	...
	public static void main(String[] args) {
		...
		new ExamSystemEx("Tops Exam System");
