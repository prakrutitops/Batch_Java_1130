            ...
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="StudentController">
                        ...
                        <div class="input-group">
                            <input class="input--style-1" type="text" placeholder="MOBILE" name="phone">
                        </div>
                        <div class="input-group">
                            <input class="input--style-1" type="password" placeholder="PASSWORD" name="password">
                        </div>
                        <div class="p-t-20">
                            <button class="btn btn--radius btn--green" type="submit" name="action" value="Register">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
